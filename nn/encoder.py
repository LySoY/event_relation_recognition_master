...
class AddOutput(nn.Module):
    ...
    def forward(self, hidden_states1, hidden_states2):
        ...
        hidden_states = self.LayerNorm(hidden_states1 + hidden_states2)
        return hidden_states
...
class DotAtt(nn.Module):
    ...
    def forward(self, input1, input2):
        ...
        value_layer1 = self.transpose_for_scores(input1)
        query_layer2 = self.transpose_for_scores(mixed_query_layer2)
        key_layer2 = self.transpose_for_scores(mixed_key_layer2)
        value_layer2 = self.transpose_for_scores(input2)
...
class DotAttention(nn.Module):
    ...
    def forward(self, input_tensor1, input_tensor2):
        return self.self(input_tensor1, input_tensor2)
